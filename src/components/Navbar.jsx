...
const NavLogo = styled(LinkR)`
  width: 70%;
  display: flex; /* Added this for horizontal layout */
  ...
  img {
    ...
    max-width: 40px; /* Set a default size for larger screens */
    height: auto;
        ...
        <Nav>
            <NavbarContainer>
                ...
                <NavItems>
                    ...
                    <NavLink href="#ProfilesSection">Profile</NavLink>
                ...
                {isOpen && (
                    <MobileMenu isOpen={isOpen}>
                        <NavLink onClick={() => setIsOpen(!isOpen)} href="#Dashboard">
                            Dashboard
                        </NavLink>
                        <NavLink onClick={() => setIsOpen(!isOpen)} href="#ProfilesSection">
                            Profile
                        </NavLink>
